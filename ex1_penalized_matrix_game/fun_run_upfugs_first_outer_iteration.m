...
% Run the special first outer iteration of PFUGS.
    ...
    [f_x0, j_x0, subgrad_f_x0] = fun_compute_max_subgradient(A, x_prev);
    ...
    while true
        ...
        x_trial = fun_entropy_two_reference_prox_update( ...
            x_prev, x_prev, grad_g_x0 + subgrad_f_x0, L_trial, L_trial);
        ...
        f_rhs = f_x0 + subgrad_f_x0' * diff_vec ...
        ...
        if g_xbar <= g_rhs + alg.ineq_tol && f_xbar <= f_rhs + alg.ineq_tol
            ...
            first_accept.active_index_last = j_x0;
            L_first = L_trial;
    ...
    while true
        ...
        trial = fun_run_upfugs_inner_subproblem(A, grad_g_x0, state, alg);
